    ...
    <footer class="text-center text-white">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/liam.b.11/" role="button" target="_blank">
                    <svg xmlns="https://www.instagram.com/liam.b.11/" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <!-- Linkedin -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/elian-jair-bardales-mendoza-10aa52304/" role="button">
                    <svg xmlns="https://www.linkedin.com/in/elian-jair-bardales-mendoza-10aa52304/" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                        <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z" />
                    </svg>
                </a>

                <!-- Github -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/elian-jair-bardales-mendoza-10aa52304/" role="button" target="_blank">
                    <svg xmlns="https://www.linkedin.com/in/elian-jair-bardales-mendoza-10aa52304/" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
        ...
        <div class="text-center p-3 bg-info">
            <p class="text-dark">2024 <a class="text-dark" href="https://github.com/BardalesE" target="_blank">BardalesR&C</a> | Sistema de ventas web </p>
        </div>
        <!-- Copyright -->
    </footer>
